...
| **[SHOULD]** Optimize GridVisuals & Selection Highlighting | **M** | [ ] | **Arch:** "Consider a MultiMeshInstance or custom shader to offload logic from CPU." / **Dev/QA:** "Performance drops during multi-unit hover/selection." / **PO:** "Crucial for 'Premium Feels' objective; target 60FPS on target hardware." |
| **[SHOULD]** Decouple UnitManager from TerrainMap via GridQueryInterface | **L** | [ ] | **Arch:** "Essential for future multi-grid or sub-grid support (e.g., inside buildings)." / **Dev/Arch:** "Refactor for better testability and isolation." / **PO:** "De-risks future scope expansions related to verticality." |
