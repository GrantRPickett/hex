...
func append_location_action(actions: Array[PlayerAction], unit: Unit, reach: ReachableState) -> void:
	...
	_add_task_summary_action(actions, results.immediate_explore, results.reachable_explore, reach.lookup, results.target_to_task, GameConstants.ActionType.EXPLORE, GameConstants.ActionIds.LOCATION_OPPOSED)
	_add_task_summary_action(actions, results.immediate_visit, results.reachable_visit, reach.lookup, results.target_to_task, GameConstants.ActionType.VISIT, GameConstants.ActionIds.LOCATION_UNOPPOSED)

func _add_task_summary_action(actions: Array[PlayerAction], immediate: Array[Location], reachable: Array[Location], reachable_lookup: Dictionary, target_to_task: Dictionary, action_type: GameConstants.ActionType, action_id: String) -> void:
