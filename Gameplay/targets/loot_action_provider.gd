...
func append_loot_action(actions: Array[UnitAction], unit: Unit, reach: ReachableState) -> void:
...
func _add_loot_action(actions: Array[UnitAction], immediate_loot: Loot, reachable_loot: Array, reachable_lookup: Dictionary, action_type: UnitAction.Type, action_id: String, target_to_task: Dictionary = {}) -> void:
