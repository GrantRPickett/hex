...
func _init(p_id: String = "", p_title: String = "New Entry", p_content: String = "", p_topic_id: String = "", p_section_id: String = "", p_entry_type: String = "generic", p_status: String = "available", p_related_id: String = ""):
	id = p_id
	title = p_title
	content = p_content
	topic_id = p_topic_id
