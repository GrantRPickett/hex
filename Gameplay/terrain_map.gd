...
const CODE_TO_TERRAIN := {
    ...
    "J": preload("res://Gameplay/Terrain/ancient_ruins.gd"),
    "K": preload("res://Gameplay/Terrain/gate_keep.gd"),
    "L": preload("res://Gameplay/Terrain/leaf_platform.gd"),
    "N": preload("res://Gameplay/Terrain/nest_village.gd"),
    ...
    "U": preload("res://Gameplay/Terrain/ruins.gd"),
