...
func execute(context: GameCommandContext, payload = null) -> CommandResult:
	...
	var target_info : Dictionary = _resolve_task_and_location(context, payload, GameConstants.TaskEvents.VISIT, faction)
	...
	if not is_instance_valid(location):
		return CommandResult.invalid_payload("Location required for visit")
