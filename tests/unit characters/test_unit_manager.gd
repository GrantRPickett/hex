...
func test_get_selected_coord() -> void:
	_manager.add_unit(_unit1, Vector2i(1, 2), true)
...
func test_get_selected_sprite() -> void:
	_manager.add_unit(_unit1, Vector2i(0, 0), true)
	assert_object(_manager.get_selected_sprite()).is_equal(_unit1)
	_manager.reset()
...
func test_is_player_controlled() -> void:
	_manager.add_unit(_unit1, Vector2i(0, 0), true)
	_manager.add_unit(_unit2, Vector2i(1, 1), false)
...
func test_goals_reached() -> void:
	_manager.add_unit(_unit1, Vector2i(0, 0), true)
	_manager.add_unit(_unit2, Vector2i(1, 1), true)
...
func test_are_all_goals_reached_ignores_enemy_units() -> void:
	_manager.add_unit(_unit1, Vector2i(0, 0), true)
	_manager.add_unit(_unit2, Vector2i(2, 2), false)
	_manager.set_goal_reached(0, true)
	assert_bool(_manager.are_all_goals_reached()).is_true()
...
func test_index_of_unit_at() -> void:
	_manager.add_unit(_unit1, Vector2i(10, 10), true)
