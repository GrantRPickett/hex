...
func test_calculate_reports_move_spaces() -> void:
	...
	var state: ReachableState = ReachableStateCalculator.calculate(setup.unit, terrain, setup.manager)
...
func test_calculate_uses_tentative_action_origin() -> void:
	...
	var state: ReachableState = ReachableStateCalculator.calculate(setup.unit, null, setup.manager)
