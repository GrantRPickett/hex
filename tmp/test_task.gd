...
func _init() -> void:
	...
	var task: Resource = load("res://Resources/level_data/zoo_test/stages/zoo_test_stage_discovery.tres").tasks[0]
	print("Task.target_id: ", task.target_id)
	print("Task.target_coord: ", task.target_coord)

	var loc: Resource = load("res://Resources/level_data/zoo_test/location_rows/zoo_test_stage_discovery_location_0.tres")
