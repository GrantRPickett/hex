...
const SELECTION_DEFAULTS := [
	{"action": DIRECT_SELECTION_PREFIX + "1", "keys": [KEY_1], "joy_buttons": [JOY_BUTTON_LEFT_SHOULDER]},
	{"action": DIRECT_SELECTION_PREFIX + "2", "keys": [KEY_2], "joy_buttons": [JOY_BUTTON_RIGHT_SHOULDER]},
	{"action": SELECTION_CYCLE_NEXT, "keys": [KEY_TAB], "joy_buttons": []},
	{"action": SELECTION_CYCLE_PREV, "keys": [KEY_BACKTAB], "joy_buttons": []},
]
